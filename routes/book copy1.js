...
//-- using GET Method to add to add the 'books' route base on id:
router.get('/books', (req, res) => {
  // new version adding the 'books' route and e fetch the books data with getBooks()...res.status(200)...
  try {
...
router.get('/books/:id', (req, res) => {
 ...
 router.put('/books/:id', (req, res) => {
    try {
      ...
      const { title, author, isbn, pages, available, genre } = req.body//to get the new JSON data that we PUT using Postman.
